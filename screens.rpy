...
screen say(who, what):
    ...
    window:
        ...
        background Transform(Image("gui/textbox.png", xalign=0.5, yalign=1.0), alpha=persistent.textboxopacity)
        if who is not None:
        ...
        text what id "what" size persistent.dialogueTextSize
...
style say_dialogue:
    ...
    #size persistent.dialogueTextSize
    outlines [(3, "#000", 0, 0)]
...
screen navigation():
    ...
    if main_menu:
        ...
        imagebutton:
            ...
            action OpenURL("https://www.patreon.com/moonboxgames")
            xalign 0.85
            yoffset 10
            
        imagebutton:
            idle Transform("ui/substar.png", zoom=0.9)
            hover Transform("ui/substar.png", zoom=1.0)
            action OpenURL("https://subscribestar.adult/grandmas-house")
            xalign 0.85
            yoffset 10
            xoffset 130
            
        imagebutton:
            idle Transform("ui/discord.png", zoom=0.9)
            hover Transform("ui/discord.png", zoom=1.0)
            action OpenURL("https://discord.gg/rpKjFWJCrz")
            xalign 0.85
            yoffset 10
            xoffset 260
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Relationships") action ShowMenu("relMenu")
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            hbox:
                ...
                imagebutton:
                    idle "gui/button/page_button_left_hover.png"
                    hover "gui/button/page_button_left_idle.png"
                    focus_mask True
                ...
                imagebutton:
                    idle "gui/button/page_button_right_hover.png"
                    hover "gui/button/page_button_right_idle.png"
                    focus_mask True
                    action FilePageNext()
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Language")
                    textbutton _("中文") text_font "tl/vagmrts/fonts/SourceHanSansCN-Bold.ttf" action Language("vagmrts")
                ...
                vbox:
                    style_prefix "radio"
                    label _("Font")
                    textbutton _("DejaVu Sans") action [gui.SetPreference("font", "DejaVuSans.ttf"), SetVariable("persistent.typeface", "DejaVuSans")]
                    textbutton _("Libre Sans") action [gui.SetPreference("font", "LibreSansSerif.ttf"), SetVariable("persistent.typeface", "LibreSansSerif")]
                    textbutton _("Redressed") action [gui.SetPreference("font", "Redressed.ttf"), SetVariable("persistent.typeface", "Redressed")]
            ...
            hbox:
                ...
                vbox:
                    ...
                    bar value Preference("text speed") left_gutter 35 right_gutter 35

                    label _("Auto-Forward Time")

                    bar value Preference("auto-forward time") left_gutter 35 right_gutter 35

                vbox:
                    style_prefix "check"
                    label _("Save Description")
                    textbutton _("On") action SetField(persistent, "namedSaves", True)
                    textbutton _("Off") action SetField(persistent, "namedSaves", False)

                # vbox:
                    # style_prefix "check"
                    # label _("Options")
                    # textbutton _("Named Saves") action SetVariable("persistent.namedSaves", (False if persistent.namedSaves == True else False))
